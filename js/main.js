...
const jobBaseData = {
  Beggar: { name: "Beggar", maxXp: 50, income: 9999999 },
  Farmer: { name: "Farmer", maxXp: 100, income: 9999999 },
  Fisherman: { name: "Fisherman", maxXp: 200, income: 9999999 },
  Miner: { name: "Miner", maxXp: 400, income: 9999999 },
  Blacksmith: { name: "Blacksmith", maxXp: 800, income: 9999999 },
  Merchant: { name: "Merchant", maxXp: 1600, income: 9999999 },

  Squire: { name: "Squire", maxXp: 100, income: 9999999 },
  Footman: { name: "Footman", maxXp: 1000, income: 9999999 },
  "Veteran footman": { name: "Veteran footman", maxXp: 10000, income: 9999999 },
  Knight: { name: "Knight", maxXp: 100000, income: 9999999 },
  "Veteran knight": { name: "Veteran knight", maxXp: 1000000, income: 9999999 },
  "Elite knight": { name: "Elite knight", maxXp: 7500000, income: 9999999 },
  "Holy knight": { name: "Holy knight", maxXp: 40000000, income: 9999999 },
  "Legendary knight": {
  ...
  Student: { name: "Student", maxXp: 100000, income: 9999999 },
  "Apprentice mage": {
    name: "Apprentice mage",
    maxXp: 1000000,
    income: 9999999
  },
  Mage: { name: "Mage", maxXp: 10000000, income: 9999999 },
  Wizard: { name: "Wizard", maxXp: 100000000, income: 9999999 },
  "Master wizard": {
    name: "Master wizard",
    maxXp: 10000000000,
    income: 9999999
...
const tooltips = {
  ...
  Tent:
    "A thin sheet of tattered cloth held up by a couple of feeble, wooden sticks. Horrible living conditions but at least you have a roof over your head.",
  "Wooden hut":
  ...
  Book:
    "A place to write down all your thoughts and discoveries, allowing you to learn a lot more quickly.",
  Dumbbells:
...
function getGameSpeed() {
  ...
  var timeWarpingSpeed = gameData.timeWarpingEnabled
    ...
    : 1;
  var gameSpeed =
    baseGameSpeed * +!gameData.paused * +isAlive() * timeWarpingSpeed;
  return gameSpeed;
}
...
function updateTaskRows() {
  for (key in gameData.taskData) {
    ...
    if (task instanceof Job) {
      ...
      valueElement.getElementsByClassName(
        "effect"
      )[0].textContent = task.getEffectDescription();
    }
  }
}
...
function updateItemRows() {
  for (key in gameData.itemData) {
    ...
    row.getElementsByClassName(
      "effect"
    )[0].textContent = item.getEffectDescription();
